...
//
////Dùng khi muốn thêm điểm nhấn nhẹ khác với Primary & Secondary
...
////phiên bản khác của surface để tạo chiều sâu
//val md_surfaceVariant = Color(0xFFDFE2EB)
//
//val md_onSurfaceVariant = Color(0xFF6B7280)   // chữ phụ, hint, icon phụ
//val md_outlineVariant = Color(0xFFE5E7EB)     // border rất nhẹ
//val md_divider = Color(0xFFE5E7EB)            // đường chia
//val md_surfaceContainerLow = Color(0xFFF9FAFB) // nền vùng nhẹ hơn surface
//val md_surfaceContainer = Color(0xFFFFFFFF)   // card / sheet trắng
...
// Nếu EasyMart đã dùng bộ màu riêng thì các màu này có thể giữ lại
// hoặc xóa sau khi chắc chắn không còn dùng.
// ==============================
